...
from .student_views import student_dashboard, student_courses, student_assignments, student_assignment_detail
...
__all__ = [
    ...
    'student_dashboard', 'student_courses', 'student_assignments', 'student_assignment_detail',
    'profile_view'
]
